...
?>
    ...
    <form class="container m-4 mx-auto rounded ms-auto " style="background-color: #EEFBFB; height: 500px;" method="POST"
        action="../editarSprint.php?idProyecto=<?php echo $idProyecto ?>&idSprint=<?php echo $idSprint ?>">
        ...
        <div class="mb-3">
            <input type="text" name="nombreSprint" value="<?php echo $nombreSprint ?>" class="form-control"
        ...
        <div class="mb-3">
            ...
            <textarea name="descripcionSprint" style="resize: none; overflow: hidden; height: 190px;"
                ...
                placeholder="[Inserte descripcion del sprint]"><?php echo $descripcionSprint ?></textarea>

        </div>
        <div class="d-grid gap-2 d-md-flex justify-content-md-end m-3">
            <button class="btn btn-success" type="submit" name="submit" value="guardar">Guardar Cambios</button>
            <button class="btn btn-danger" type="submit" name="submit" value="deshabilitarSprint">Deshabilitar
                Sprint</button>
