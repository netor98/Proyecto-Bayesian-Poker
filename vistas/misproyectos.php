...
include "$rutaDirectorio/header.php";
  ...
  <div class="container border border-info m-3 mx-auto p-3" style="height: auto; width: auto; ">
    ...
    <p class="fs-6 fw-normal text-center" style="color: white;">Selecciona un proyecto que quieras ver o editar, tambien puedes crear uno nuevo o unirte a uno existente</p>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end ">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop">Unirse a un proyecto</button>
