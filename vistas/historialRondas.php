...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        ...
        for ($i = 0; $i < count($rondas); $i++) {
          ...
          echo "<a href='#' class='list-group-item list-group-item-action' data-bs-toggle='modal' data-bs-target='#exampleModal2' onclick=\"setDescripcion('" . str_replace(array("\n", "\r"), "\\n", addslashes(htmlspecialchars($rondas[$i]['descripcion'], ENT_QUOTES))) . "')\">" . $rondas[$i]['nombre'] ."</a>";
